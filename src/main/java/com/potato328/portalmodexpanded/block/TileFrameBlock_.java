...
public class TileFrameBlock_ extends FrameBlock {
    ...
    public TileFrameBlock_(Properties properties, boolean isFilled) {
    ...
    public VoxelShape getShape(BlockState state, IBlockReader level, BlockPos pos, ISelectionContext context) {
        ...
        return CACHE.computeIfAbsent(state, this::getHollowShape);
    }

    private VoxelShape getHollowShape(BlockState state) {
        ...
        return HOLLOW_SHAPE.get(state.getValue(FACING)).getVariant(hasBeam ? "beam" : "");
    }
